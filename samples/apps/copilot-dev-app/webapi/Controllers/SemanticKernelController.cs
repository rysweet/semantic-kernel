...
public class SemanticKernelController : ControllerBase
{
    ...
    {
        this._logger.LogInformation("Received call to invoke {SkillName}/{FunctionName}", skillName, functionName);

        string semanticSkillsDirectory = "SemanticSkillsDirectory";
        //if (!string.IsNullOrWhiteSpace(semanticSkillsDirectory))
        //{
        this._logger.LogInformation("Registering semantic skills from {SemanticSkillsDirectory}", semanticSkillsDirectory);
