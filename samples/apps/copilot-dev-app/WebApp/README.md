...
This experience is a web interface for defining an application that you will co-build with multiple LLM functions assuming the roles of a virtual software development team, with dedicated LLM prompt environments for each job-to-be-done on the team such as program management, lead architect, engineering manager or scrum master, programmers, code reviewers, testers, and devops or infrastructure personnel.
